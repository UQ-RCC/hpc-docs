...
* I understand that a basic knowledge of Unix is required to use HPC efficiently. 

* I understand that I should make reasonable effort to learn about Bunya and its efficient and appropriate usage before running calculations on Bunya. The Bunya User Guide can be found here https://github.com/UQ-RCC/hpc-docs 
...
* I understand that the space provided to me in /scratch/user is for data of current calculations only. It is not backed up and it should not be used to store data. I understand that files that have not been used in 90 days will be automatically deleted without me being notified about this. 
...
* I understand that I must not create a tunnel such that I or any other person can connect to Bunya via any method not provided by the Research Computing Centre (e.g. via SSH or onBunya).
