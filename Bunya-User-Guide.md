...
NOTE: Apptainer is *not* installed on the Bunya login nodes. You must use an interactive job via the batch system to be able to do use a software container.
